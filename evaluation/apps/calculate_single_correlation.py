...
def main():
    ...
    if not file_name:
        ...
        file_list = sorted(os.listdir(f"output/apps/{test_case}"))
        for file_name in file_list:
            if file_name.startswith("other-metrics"):
                print_other_correlation(f"output/apps/{test_case}/{file_name}")
            else:
                print_correlation(f"output/apps/{test_case}/{file_name}")
    else:
        if file_name.startswith("other-metrics"):
            print_other_correlation(f"output/apps/{test_case}/{file_name}")
        else:
